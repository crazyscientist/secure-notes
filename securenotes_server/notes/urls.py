...
urlpatterns = [
    ...
    path('note/<int:content_id>/setkey/', views.KeyView.as_view({'put': 'put', 'post': 'post'}), name="aes_keys_set"),
    path('note/<int:content_id>/getkey/', views.KeyView.as_view({'get': 'get'}), name="aes_keys_get"),
